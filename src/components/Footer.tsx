      ...
      <div className="container-page py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <p className="mt-5 max-w-md text-[15px] leading-relaxed text-primary-foreground/80 dark:text-muted-foreground">
              {t("footer.tagline")}
            </p>
            <div className="mt-6 space-y-2 text-sm text-primary-foreground/85 dark:text-muted-foreground">
          ...
          <div className="md:col-span-4">
            <h4 className="text-xs font-semibold uppercase tracking-[0.18em] text-primary-foreground dark:text-foreground">
        ...
        <div className="mt-14 flex flex-col items-start justify-between gap-3 border-t border-primary-foreground/20 pt-6 text-xs text-primary-foreground/75 dark:border-border dark:text-muted-foreground md:flex-row md:items-center">
