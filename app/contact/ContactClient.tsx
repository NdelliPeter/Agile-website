...
const contactImg = "/assets/Porte%20Djerba.jpg";
  ...
  return (
    <AppLayout>
      <section className="container-page pt-20 md:pt-28">
        <SectionHeading title={t("contact.headline")} size="lg" widthClassName="max-w-[80%]" />
      </section>
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:gap-16">
          <div className="md:col-span-5">
            ...
            <img
              ...
              alt=""
              loading="lazy"
              className="mt-10 aspect-square w-full object-cover object-center"
            />
          </div>
          ...
          <div className="md:col-span-7">
            {submitted ? (
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="text-primary text-[16px] font-bold mb-2 block">
