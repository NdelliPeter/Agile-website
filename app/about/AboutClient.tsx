...
import { VerticalPipeline } from "@/app/components/Pipeline";

const logoImg = "/assets/logo.png";
const aboutHeroImg = "/assets/Alex%20Uzbek%201%20Noir%20%26%20Blanc.jpeg";
  ...
  return (
    <AppLayout>
      ...
      <section className="container-page pt-20 md:pt-28">
        <SectionHeading title={t("about.header.title")} intro={t("about.header.intro")} size="xl" />
      </section>
      ...
      <section className="container-page py-20 md:py-28">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-16">
          <div className="border-border pt-8">
            <div className="eyebrow tracking-[0px] text-primary text-[28px] font-bold mb-4">
