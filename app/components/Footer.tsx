...
export function Footer() {
  ...
  return (
    <footer
      ...
      className="mt-24 border-t border-primary/40 bg-primary text-primary-foreground dark:border-border dark:bg-background dark:text-foreground"
    >
      {/* Newsletter band */}
          ...
          <div className="md:col-span-2">
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              <li>
                <Link
                  href="/about"
                  className="text-primary-foreground/80 hover:text-primary-foreground dark:text-muted-foreground dark:hover:text-foreground"
                >
                  {t("common.nav.about")}
                </Link>
              </li>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3 border-t border-primary-foreground/20 pt-6 text-[10.5px] font-medium uppercase tracking-[0.2em] text-primary-foreground/65 dark:border-border dark:text-muted-foreground">
          {credentials.map((c, i) => (
            <span key={c} className="inline-flex items-center gap-3">
              {i > 0 && (
                <span className="h-1 w-1 rounded-full bg-primary-foreground/40 dark:bg-border" />
              )}
              {c}
            </span>
          ))}
