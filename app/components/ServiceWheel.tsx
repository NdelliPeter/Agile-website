...
import { SERVICE_KEYS, type ServiceKey } from "@/app/lib/services-data";
        ...
        {SERVICE_KEYS.map((key, i) => {
          ...
          return (
            ...
            >
              ...
              <div className="[animation:spin_50s_linear_infinite_reverse] [animation-play-state:paused] max-lg:motion-safe:[animation-play-state:running] motion-safe:lg:group-hover:[animation-play-state:running]">
                <Link
                  href={`/services/${key}`}
